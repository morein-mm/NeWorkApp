...
//            показывать delete только, если смотрим джобы текущего авторизованного пользователя
    ...
    companion object {
        private val outgoingDateTimePattern: DateTimeFormatter =
            DateTimeFormatter.ofPattern("dd MMMM yyyy")

        fun getItemDateTime(itemDateTime: String): String = OffsetDateTime
            .parse(itemDateTime, DateTimeFormatter.ISO_OFFSET_DATE_TIME)
            .toLocalDateTime()
